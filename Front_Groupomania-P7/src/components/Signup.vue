                            ...
                            <div class="row">
                                <div class="col-lg-10 col-xl-7 mx-auto">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <input id="inputJob" type="text" placeholder="Job title" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4" />
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="text-center d-flex justify-content-between mt-4"><p>Vous avez déjà un compte ? <a href="http://localhost:3000/login">LOGIN</a></p></div>
                                    </form>
                                </div>
                            </div>
                        </div>
